...
public class EmailConstant {
    ...
    public static final String USERNAME = "kouraihiahmed2@gmail.com";
    public static final String PASSWORD = "zymndjgovuaanxnx";
    public static final String FROM_EMAIL = "kouraihiahmed2@gmail.com\"";
